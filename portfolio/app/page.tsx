          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <p className="text-lg text-muted-foreground max-w-2xl">
                  Sou estudante de Ciência da Computação com foco na área de dados. Tenho experiência em automação de
                  processos, análise de dados e desenvolvimento de soluções usando Python e SQL.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="gradient-border p-6 bg-card">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <h4 className="font-medium">Professor voluntário</h4>
                        <p className="text-sm text-muted-foreground">
                          Universidade Ritter dos Reis | 02/2024 - 07/2024
                        </p>
                        <ul className="list-disc list-inside text-sm mt-2 text-muted-foreground">
                          <li>
                            Mentoria para estudantes, orientando-os nos primeiros passos para ingressar nas áreas de TI.
                          </li>
                          <li>Conduzi oito aulas focadas em fluxogramas, POO e Python.</li>
                          <li>Projetei materiais didáticos e atividades para os alunos.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
